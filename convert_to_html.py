...
MD_FILES = [
    ...
    'lidar-lab-guide.md',
    'lidar-quick-reference.md',
    'lidar-instructor-guide.md',
]

# 文件标题映射
TITLE_MAP = {
    'lidar-teaching-material.md': '机械旋转式激光雷达教学演示系统',
    'lidar-lab-guide.md': 'LiDAR 实验指导书',
    'lidar-quick-reference.md': 'LiDAR 快速参考手册',
    'lidar-instructor-guide.md': 'LiDAR 教学教师手册',
}

def get_html_template(title='机械旋转式激光雷达教学演示系统'):
    return '''<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
def convert_file(md_filename):
    ...
    title = TITLE_MAP.get(md_filename, 'LiDAR 教学文档')
    ...
    # 生成完整 HTML
    full_html = get_html_template(title).format(content=html_content)
